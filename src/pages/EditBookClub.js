...
function EditBookClubPage() {
   const {user, setUser, bookClub, setBookClub, getBookClubs} = useContext(LoadingContext)
      ...
      <div className="flex flex-col items-center justify-center w-full mt-10 md:flex-row">
            ...
            <div className="flex flex-col items-center justify-between mt-5 space-y-4 md:ml-10 md:mt-0">
               ...
               <form className="flex flex-col justify-between mt-5 md:ml-10 md:mt-0" onSubmit={handleSubmit}>
                  ...
                  <input type='email' name="meetingLink" value={bookClub.meetingLink} onChange={handleChange} className="px-4 py-2 border border-green-700 border-opacity-50"></input>

                  <label className="text-green-700 text-opacity-75">Book Club Image</label>
                  <input type='file' name="clubImg" value={bookClub.clubImg} onChange={handleChange} accept=".jpg, .jpeg, .png, .pdf" className="px-4 py-2 border border-green-700 border-opacity-50"></input>
